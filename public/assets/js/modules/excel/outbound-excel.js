...
//     // Convert stepNumber to the correct format
//     const stepId = typeof stepNumber === 'number' ? `step${stepNumber}` : stepNumber.toString();
//     const step = document.getElementById(stepId);
    
//     if (!step) {
//         console.error(`❌ [Step ${stepNumber}] Step element not found for ID: ${stepId}`);
//         return;
//     }
...
//         errorContent = error.validationErrors.map((err, index) => {
...
//                         </span>
//                         <span class="content-title" style="text-align: center;">${err.row}</span>
//                     </div>
//                     ${errors.map(e => `
//                         <div class="content-desc">
...
//         customClass: {
//             confirmButton: 'semi-minimal-confirm',
//             cancelButton: 'semi-minimal-cancel',
//             popup: 'semi-minimal-popup'
//         }
//     }).then((result) => {
