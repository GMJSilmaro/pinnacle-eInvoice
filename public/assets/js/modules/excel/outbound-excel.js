                    ...
                    error: (xhr, error, thrown) => {
                        ...
                        try {
                            ...
                            if (response && response.error) {
                                errorMessage = response.error.message || response.error.details || errorMessage;
                        ...
                        // Ensure table shows empty state
                        this.showEmptyState('Error loading data. Please try again.');
                    }
                },
                columns: [
                    {
